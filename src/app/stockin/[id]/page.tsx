...
export default function StockInDetail() {
  ...
  useEffect(() => {
    const fetchSuppliers = async () => {
      ...
      try {
        const response = await fetch(
          `https://hr-inventory-be.final25.psewmad.org/api/supplier/getAll`,
          {
            method: "GET",
            headers: {
    ...
    const fetchProducts = async () => {
      ...
      try {
        const response = await fetch(
          `https://hr-inventory-be.final25.psewmad.org/api/product/getAll`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
    ...
    const fetchStockinByInvoiceId = async (invoiceId: string) => {
      ...
      try {
        const response = await fetch(
          `https://hr-inventory-be.final25.psewmad.org/api/stockIn/${invoiceId}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleUpdateItem = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `https://hr-inventory-be.final25.psewmad.org/api/stockIn/${formData.invoice_id}/${selectedItem.item_id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteItem = async (itemId: string) => {
    ...
    try {
      setLoading(true);
      const res = await fetch(
        `https://hr-inventory-be.final25.psewmad.org/api/stockIn/${formData.invoice_id}/${itemId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDeleteInvoice = async (invoiceId: string) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://hr-inventory-be.final25.psewmad.org/api/stockIn/delete/${invoiceId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      setFormData((prev) => ({
        ...
        invoices:
          prev.invoices?.filter(
            (i: { invoice_id: string }) => i.invoice_id !== invoiceId
          ) || [],
      }));
      router.push("/stockin");
    } catch (err) {
