...
//     } else {
//       const errorData = await response.json();
//       setError(errorData.message || "Failed to fetch stock-in by invoice ID.");
//     }
//   } catch (err) {
//     setError("Network error. Please try again.");
//   } finally {
...
//   }
// };
// fetchStockinByInvoiceId(invoiceId)

//   }, []);

 
// //  useEffect(() => {
// //     if (!invoiceId || !itemId) return; // Wait until both are available
...
// //         const response = await fetch(
// //           `${process.env.NEXT_PUBLIC_API_BASE_URL}/stockIn/${invoiceId}/${itemId}`,
// //           {
// //             method: "GET",
// //             headers: {
// //               "Content-Type": "application/json",
...
// //         if (response.ok) {
// //           const result = await response.json();
// //           const data = result; // or result.data depending on your API
// //           console.log("Fetched Data:", data);
// //           setFormData(data);
// //         } else {
// //           const errorData = await response.json();
// //           setError(errorData.message || "Failed to fetch invoice item.");
// //         }
// //       } catch (err) {
...
//           "Authorization": `Bearer ${token}`,
//         },
//         body: JSON.stringify(formData), // formData should have product_id, quantity, unit_price, expire_date
//       }
//     );

//     if (response.ok) {
//       alert("Item updated successfully!");
//       route.push(`/stockin/${invoiceId}`); // redirect to invoice detail or wherever
//     } else {
//       const errData = await response.json();
//       alert("Failed to update item: " + (errData.error || "Unknown error"));
//     }
//   } catch (error) {
  ...
  useEffect(() => {
    ...
    const fetchStockinByInvoiceId = async (invoiceId: string) => {
      ...
      try {
        ...
        setError("Failed to fetch stockin by ID");
      }
    };
